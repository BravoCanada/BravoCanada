	            ...
	            <form role="form" action="<?php echo base_url('admin/user/editUser');?>" method="post">
	              <div class="box-body">
		            ...
		            <div class="row">
		             ...
		             <div class="row">
		                 <div class="form-group col-md-6">
		                  <label for="com_website">Company Website</label>
		                  <input type="text" class="form-control" name="com_website" id="com_website" placeholder="Company Website" value="<?php echo isset($user) ? $user->com_website : ''?>">
		                </div>
		             </div>
		             <div class="row">
		                <div class="form-group col-md-6">
		             ...
		             <div class="row">
		                 <div class="form-group col-md-6">
		                  ...
		                  <select name="user_role" id="user_role" class="form-control">
		                  	...
		                  	<option value="transporter" <?php echo isset($user) ? (($user->user_role =='transporter') ? 'selected' : '') : ''?>>Transporter</option>
