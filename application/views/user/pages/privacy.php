<style>
	    ...
	    section [role="contact-section"] h5{
			font-size: 26px;
		}
		
		section [role="contact-section"] p{
			font-size: 16px;;
		}
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-left mt-5">
						...
						<p class="py-4">Bravo Canada ("us", "we", or "our") operates the www.bravocan.ca website (the "Service").</p>
						...
						<p class="py-4">We use your data to provide and improve the Service. By using the Service, you agree to
						...
						in our Terms and Conditions, accessible from www.bravocan.ca</p>
						
						<h5>Information Collection And Use</h5>
						
						<p class="py-4">We collect several different types of information for various purposes to provide and improve
							our Service to you.</p>
							
						<h5 class="py-4">Types of Data Collected</h5>
						
						<p style="font-size:20px;">Personal Data</p>
						
						<p class="py-4">While using our Service, we may ask you to provide us with certain personally identifiable
						...
						<p style="font-size:20px;" class="py-4">Usage Data</p>
						...
						<p style="font-size:20px;" class="py-4">Tracking & Cookies Data</p>

						<p>We use cookies and similar tracking technologies to track the activity on our Service and
						hold certain information.</p>
						
						<p class="py-3">Cookies are files with small amount of data which may include an anonymous unique
						...
						<p class="py-3">Examples of Cookies we use:</p>
							<ul>
							...
							<p style="font-size:20px;" class="py-3">Use of Data<p>
							
							<p>Bravo Canada uses the collected data for various purposes:</p>
							...
							<p style="font-size:20px;">Transfer Of Data</p>
							
							<p class="py-3">Your information, including Personal Data, may be transferred to — and maintained on —
							...
							<p>If you are located outside Canada and choose to provide information to us, please note that
							we transfer the data, including Personal Data, to Canada and process it there.</p>
							
							<p class="py-3">Your consent to this Privacy Policy followed by your submission of such information
							represents your agreement to that transfer.</p>
							
							<p>Bravo Canada will take all steps reasonably necessary to ensure that your data is treated
							...
							<p style="font-size:22px;" class="py-3">Disclosure Of Data</p>
							
							<h5>Legal Requirements</h5>
							
							<p class="py-3">Bravo Canada may disclose your Personal Data in the good faith belief that such action is
							necessary to:<p>
							<ul>
								<li>To comply with a legal obligation</li>
								<li>To protect and defend the rights or property of Bravo Canada</li>
								<li>To prevent or investigate possible wrongdoing in connection with the Service</li>
								<li>To protect the personal safety of users of the Service or the public</li>
								<li>To protect against legal liability</li>
							</ul>
							
							<h5 class="py-3">Security Of Data</h5>
							...
							<h5 class="py-3">Service Providers</h5>
							...
							<p class="py-3">These third parties have access to your Personal Data only to perform these tasks on our
							behalf and are obligated not to disclose or use it for any other purpose.</p>
							
							<h5>Analytics</h5>
							
							<p class="py-3">We may use third-party Service Providers to monitor and analyze the use of our Service.</p>
							  <ul>
								...
								network.</li>
								<li>You can opt-out of having made your activity on the Service available to Google
								...
								information with Google Analytics about visits activity.</li>
								<li>For more information on the privacy practices of Google, please visit the Google</li>
						     </ul>
							
							<p class="py-3">Privacy & Terms web page: https://policies.google.com/privacy?hl=en</p>
							
							<h5>Links To Other Sites</h5>
							
							<p class="py-3">Our Service may contain links to other sites that are not operated by us. If you click on a
							...
							<h5 class="py-3">Children's Privacy</h5>
							
							<p>Our Service does not address anyone under the age of 18 ("Children").</p>
							
							<p class="py-3">We do not knowingly collect personally identifiable information from anyone under the age of
							...
							<p class="py-3">We may update our Privacy Policy from time to time. We will notify you of any changes by
							posting the new Privacy Policy on this page.</p>
							
							<p class="py-3">We will let you know via email and/or a prominent notice on our Service, prior to the change
							...
							<p class="py-3">If you have any questions about this Privacy Policy, please contact us:</p>
							  <ul>
								<li>By email: support@bravocan.ca</li>
								<li>By phone number: +1-416-883-955</li>
							  </ul>
