	    			...
	    			<div class="col-md-12">
	    				<h1>
	    					...
	    					<?php
	    						...
	    						if(isset($location_en))
	    						{
	    							echo $location_en[0]->course_title_en;
	    						}

	    						if(isset($location_sp))
	    						{
	    							echo $location_sp[0]->course_title_sp;
		    					}

		    					if(isset($location_tk))
		    					{
		    						echo $location_tk[0]->course_title_tk;
		    					}

		    					if(isset($location_pr))
		    					{
		    						echo $location_pr[0]->course_title_pr;
		    					}
				...
				<div class="row py-5">
					<?php if(isset($location_en)):?>
						<?php foreach($location_en as $rows):?>
							<div class="col-md-3 top-imgs" style="background-image: url('<?php echo base_url('uploads/'.$rows->location_image);?>') ; background-repeat: no-repeat; max-width: 23%; margin-right: 12px;">
								<h2><a href="<?php echo base_url('home/showCourse/'.$rows->location_id);?>"><?php echo $rows->location_name;?></a></h2>
					...
					<?php if(isset($location_sp)):?>
						<?php foreach($location_sp as $rows):?>
							<div class="col-md-3 top-imgs" style="background-image: url('<?php echo base_url('uploads/'.$rows->location_image);?>') ; background-repeat: no-repeat; max-width: 23%; margin-right: 12px;">
								<h2><a href="<?php echo base_url('home/showCourse/'.$rows->location_id);?>"><?php echo $rows->location_name_sp;?></a></h2>
								<div class="btm-border">
								</div>
							</div>
						<?php endforeach;?>
					...
					<?php if(isset($location_tk)):?>
						<?php foreach($location_tk as $rows):?>
							<div class="col-md-3 top-imgs" style="background-image: url('<?php echo base_url('uploads/'.$rows->location_image);?>') ; background-repeat: no-repeat; max-width: 23%; margin-right: 12px;">
								<h2><a href="<?php echo base_url('home/showCourse/'.$rows->location_id);?>"><?php echo $rows->location_name_tk;?></a></h2>
								<div class="btm-border">
								</div>
							</div>
						<?php endforeach;?>
					...
					<?php if(isset($location_pr)):?>
						<?php foreach($location_pr as $rows):?>
							<div class="col-md-3 top-imgs" style="background-image: url('<?php echo base_url('uploads/'.$rows->location_image);?>') ; background-repeat: no-repeat; max-width: 23%; margin-right: 12px;">
								<h2><a href="<?php echo base_url('home/showCourse/'.$rows->location_id);?>"><?php echo $rows->location_name_pr;?></a></h2>
								<div class="btm-border">
								</div>
							</div>
						<?php endforeach;?>
