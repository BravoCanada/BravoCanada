      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-primary">
               <form role="form" action="<?php echo base_url('admin/courseimage/addCourseImage');?>" method="post" enctype="multipart/form-data">
                                     ...
                                     <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group col-md-12">
                                             ...
                                             <textarea name="location_iframe" id="" cols="4" rows="2" class="form-control"></textarea>
                                          </div>
                                       </div>                                           
                                     </div>
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group col-md-12">
                                             <label for="">Location iframe</label>
                                             <textarea name="location_iframe_sp" id="" cols="4" rows="2" class="form-control"></textarea>
                                          </div>
                                       </div>                                           
                                     </div>                                   
                                 </div>                               
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group col-md-12">
                                             <label for="">Location iframe</label>
                                             <textarea name="location_iframe_tk" id="" cols="4" rows="2" class="form-control"></textarea>
                                          </div>
                                       </div>                                           
                                     </div>                            
                                 </div>                               
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group col-md-12">
                                             <label for="">Location iframe</label>
                                             <textarea name="location_iframe_pr" id="" cols="4" rows="2" class="form-control"></textarea>
                                          </div>
                                       </div>                                           
                                     </div>                           
                                 </div>                               
