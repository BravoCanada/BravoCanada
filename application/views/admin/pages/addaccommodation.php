      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-primary">
               <form role="form" action="<?php echo base_url('admin/Accommodation/addAccommodation');?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                      <div class="col-md-4">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="supp_fee_en" placeholder="Other Supplement Fee">                     
                                         </div>
                                      </div>
                                    </div>
                                    <div id="acc_div_en">
                                       <div class="row">
                                          <div class="col-md-4">
                                             <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="acc_title_en[]" placeholder="Accommodation Title">                     
                                             </div>
                                          </div>
                                          <div class="col-md-4">
                                             <div class="form-group col-md-6">
                                                <label for="">Single</label>
                                                <input type="text" name="single_en[]" class="form-control">                                                                                          
                                             </div> 
                                             <div class="form-group col-md-6">
                                                <label for="">Status</label>
                                                <input type="text" name="single_status_en[]" class="form-control" placeholder="e.g p/week">                                                                                     
                                             </div>                                            
                                          </div> 
                                           <div class="col-md-4">
                                             <div class="form-group col-md-6">
                                                <label for="">Double</label>
                                                <input type="text" name="double_en[]" class="form-control">                                                                                                                                          
                                             </div> 
                                              <div class="form-group col-md-6">
                                                <label for="">Status</label>
                                                <input type="text" name="double_status_en[]" class="form-control" placeholder="e.g p/week">                                                                                                                                       
                                             </div>                                             
                                          </div>                                          
                                       </div>                                     
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-md-4">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="supp_fee_sp" placeholder="Other Supplement Fee">                     
                                         </div>
                                      </div>
                                    </div>
                                    <div id="acc_div_sp">
                                       <div class="row">
                                          <div class="col-md-4">
                                             <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="acc_title_sp[]" placeholder="Accommodation Title">                     
                                             </div>
                                          </div>
                                          <div class="col-md-4">
                                             <div class="form-group col-md-6">
                                                <label for="">Single (spanish)</label>
                                                <input type="text" name="single_sp[]" class="form-control">                                                                                         
                                             </div> 
                                              <div class="form-group col-md-6">
                                                <label for="">Status (spanish)</label>
                                                <input type="text" name="single_status_sp[]" class="form-control" placeholder="e.g p/week">                                                                                        
                                             </div>                                               
                                          </div> 
                                           <div class="col-md-4">
                                             <div class="form-group col-md-6">
                                                <label for="">Double (spanish)</label>
                                                <input type="text" name="double_sp[]" class="form-control">                                                                                          
                                             </div> 

                                             <div class="form-group col-md-6">
                                                <label for="">Status (spanish)</label>
                                                <input type="text" name="double_status_sp[]" class="form-control" placeholder="e.g p/week">                                                                                        
                                             </div>                                             
                                          </div>                                          
                                       </div>                                     
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-md-4">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="supp_fee_tk" placeholder="Other Supplement Fee">                     
                                         </div>
                                      </div>
                                    </div>
                                    <div id="acc_div_tk">
                                       <div class="row">
                                          <div class="col-md-4">
                                             <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="acc_title_tk[]" placeholder="Accommodation Title">                     
                                             </div>
                                          </div>
                                          <div class="col-md-4">
                                             <div class="form-group col-md-6">
                                                <label for="">Single (turkish)</label>
                                                <input type="text" name="single_tk[]" class="form-control">                                                                                          
                                             </div> 
                                             <div class="form-group col-md-6">
                                                <label for="">Status (turkish)</label>
                                                <input type="text" name="single_status_tk[]" class="form-control" placeholder="e.g p/week">                                                                                          
                                             </div>                                             
                                          </div> 
                                           <div class="col-md-4">
                                             <div class="form-group col-md-6">
                                                <label for="">Double (turkish)</label>
                                                <input type="text" name="double_tk[]" class="form-control">                                                                                           
                                             </div>  
                                             <div class="form-group col-md-6">
                                                <label for="">Status (turkish)</label>
                                                <input type="text" name="double_status_tk[]" class="form-control" placeholder="e.g p/week">                                                                                           
                                             </div>                                            
                                          </div>                                          
                                       </div>                                     
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-md-4">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="supp_fee_pr" placeholder="Other Supplement Fee">                     
                                         </div>
                                      </div>
                                    </div>
                                    <div id="acc_div_pr">
                                       <div class="row">
                                          <div class="col-md-4">
                                             <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="acc_title_pr[]" placeholder="Accommodation Title">                     
                                             </div>
                                          </div>
                                          <div class="col-md-4">
                                             <div class="form-group col-md-6">
                                                <label for="">Single (progish)</label>
                                                <input type="text" name="single_pr[]" class="form-control">                                                                                        
                                             </div> 
                                             <div class="form-group col-md-6">
                                                <label for="">Single (progish)</label>
                                                <input type="text" name="single_status_pr[]" class="form-control" placeholder="e.g p/week">                                                                                        
                                             </div>                                            
                                          </div> 
                                           <div class="col-md-4">
                                             <div class="form-group col-md-6">
                                                <label for="">Double (progish)</label>
                                                <input type="text" name="double_pr[]" class="form-control">                                                                                          
                                             </div>  
                                             <div class="form-group col-md-6">
                                                <label for="">Status (progish)</label>
                                                <input type="text" name="double_status_pr[]" class="form-control"  placeholder="e.g p/week">                                                                                          
                                             </div>                                            
                                          </div>                                          
                                       </div>                                     
                                    </div>
