      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-primary">
               <form role="form" action="<?php echo base_url('admin/Additionalfee/addAdditionalFees');?>" method="post" enctype="multipart/form-data">
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="fee_name_en[]" placeholder="Fee Name">                     
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                             <div class="form-group col-md-12">
                                                <label for="">Price</label>
                                                <textarea name="price_en[]" cols="1" rows="1" class="form-control"></textarea>
                                             </div>                                             
                                          </div>                                         
                                       </div>                                     
                                    </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="fee_name_sp[]" placeholder="Fee Name">                     
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                             <div class="form-group col-md-12">
                                                <label for="price_sp">Price (spanish)</label>
                                                <textarea name="price_sp[]" cols="1" rows="1" class="form-control"></textarea>
                                             </div>
                                          </div>
                                       </div>                                     
                                    </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="fee_name_tk[]" placeholder="Fee Name">                     
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                             <div class="form-group col-md-12">
                                                <label for="price_tk">Price (turkish)</label>
                                                <textarea name="price_tk[]" cols="1" rows="1" class="form-control"></textarea>
                                             </div>
                                          </div>
                                       </div>                                     
                                    </div>

                                    <a href="javascript:void(0);" id="fee_add_more_tk" class="pull-right">+Add More Fee</a>
                                 </div>                               
                              </div>
                           </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="fee_name_pr[]" placeholder="Fee Name">                     
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                             <div class="form-group col-md-12">
                                                <label for="price_pr">Price (progish)</label>
                                                <textarea name="price_pr[]" cols="1" rows="1" class="form-control"></textarea>
                                             </div>
                                          </div>
                                       </div>                                     
                                    </div>

                                    <a href="javascript:void(0);" id="fee_add_more_pr" class="pull-right">+Add More Fee</a>
                                 </div>                               
                              </div>
                           </div>
                           <!-- /.tab-pane -->                         
