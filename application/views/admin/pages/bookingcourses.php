              ...
              <table id="booking_table" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                  <?php foreach($booking_details as $rows):?>
                      <tr>                        
                          <td><?php echo ucfirst($rows->fname);?></td>
                          <td><?php echo ucfirst($rows->lname);?></td>
                          <td><?php echo $rows->email;?></td>
                          <td><?php echo $rows->phone_no;?></td>                        
                          <td><?php echo ucfirst($rows->course_title_en);?></td>
                          <td><?php echo ucfirst($rows->location_name);?></td>
