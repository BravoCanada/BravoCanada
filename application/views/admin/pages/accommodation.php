            ...
            <div class="box">
               <div class="box-body">
                  <table id="courseTable" class="table table-striped table-bordered" style="width:100%">
                     ...
                     <tbody>         
                        <?php foreach($accommodation as $rows):?>
                            <tr>
                               ...
                               <td>                       
                                  <a href="<?php echo base_url('admin/Accommodation/editAccommodation/'.$rows->acc_id);?>" class="btn btn-primary">Edit</a>
                                  <a href="<?php echo base_url('admin/Accommodation/deleteAccommodation/'.$rows->acc_id);?>" class="btn btn-danger">Delete</a>
                               </td>
                            </tr>
                        <?php endforeach;?>
